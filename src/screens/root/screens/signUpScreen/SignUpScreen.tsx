...
export function SignUpScreen({
  navigation,
}: RootScreenProps<typeof screens.SIGN_UP>) {
    ...
    <View
          ...
          <View style={inputsContainer}>
            ...
            <View style={inputContainer}>
              <SWTextInput
                ...
                onChangeText={t => {
                  updateField('email', t);
                  touched.email && validateField('email', values.email);
                }}
                onBlur={() => {
                  touchField('email');
      ...
      <View style={[buttons]}>
        <Button
          ...
          disabled={
            !checkErrors(['email', 'password', 'username']) ||
            !checkTouched(['email', 'password', 'username'])
          }
        />
        <Button
          type="link"
